...
[_DVORAK] = LAYOUT_planck_grid(
    ...
    KC_LCTL, EXTRA,   KC_LGUI, KC_LALT, LOWER,   KC_SPC,  XXXXXXX, RAISE,   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, UML_A,   RNG_A,   KC_LPRN, KC_RPRN, _______, _______, KC_MINS, KC_EQL,  UML_O,   _______, KC_BSLS,
